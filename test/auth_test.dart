...
import 'package:demo2/services/auth/auth_user.dart';
...
class MockAuthProvider implements AuthProvider{
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    if (!isInitialized) throw NotInitializedException();
    if (email== 'bishal@gmail.com') throw UserNotFoundAuthException();
    if (password=='armystadium') throw WrongPasswordAuthException();
